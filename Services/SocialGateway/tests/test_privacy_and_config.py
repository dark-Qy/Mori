...
def test_configuration_reads_bounded_environment_values() -> None:
    config = GatewayConfig.from_environment(
        {
            ...
            "SOCIAL_TRANSFER_ANIMATION_LEAD_SECONDS": "1.5",
            "SOCIAL_TRANSFER_ANIMATION_DURATION_MS": "1000",
    ...
    assert config == GatewayConfig(
        ...
        transfer_animation_lead_seconds=1.5,
        transfer_animation_duration_ms=1000,
...
@pytest.mark.parametrize(
    ...
    [
        ...
        {"SOCIAL_TRANSFER_ANIMATION_LEAD_SECONDS": "0.1"},
        {"SOCIAL_TRANSFER_ANIMATION_DURATION_MS": "100"},

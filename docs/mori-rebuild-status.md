...
| Current revision | G7 Mock-first Mori conversation checkpoint |
| Active goal | G8 — End-to-end product loops; G4 motion merge remains deferred |
| Goal state | G5–G7 Mock-first platform experiences are implemented; G7 final regression and visual evidence are recorded below |
| Contract | G0–G3 and G5–G7 committed by this checkpoint; black G4 handoff ready but not merged; white Mori deferred |

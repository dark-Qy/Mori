Create one horizontal runtime animation strip for character `bili_22`, action `touch_head`.
...
Identity lock: 只生成 22 娘：深钴蓝超长发、闪电形呆毛、品红眼睛、刘海旁白色矩形表情发夹、白色短袖上衣、深蓝领带与裙装、白手套和白色未来感鞋。绝不能出现浅蓝发的 33 娘或双人组合。
...
Motion: Frame 00 starts in the approved neutral stance. Frame 01 dips the head slightly. Frames 02-04 close the eyes into a warm happy expression with a tiny head lean and subtle hair follow-through. Frames 05-07 reopen the eyes and settle smoothly back to the exact neutral stance.
